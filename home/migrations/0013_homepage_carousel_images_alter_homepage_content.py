# Generated by Django 4.2.5 on 2023-10-19 13:42
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('home', '0012_remove_homepage_carousel_images_and_more'),
    ]
    ...
    operations = [
        migrations.AddField(
            ...
            field=wagtail.fields.StreamField([('carousel_image', wagtail.blocks.StructBlock([('images', wagtail.blocks.ListBlock(wagtail.blocks.StructBlock([('image', wagtail.images.blocks.ImageChooserBlock(required=True))])))]))], blank=True, use_json_field=True),
        ),
